...
urlpatterns = [
    ...
    path('bot/templates/', views_panel_catalog.StoreTemplateListView.as_view(), name='bot_templates'),
    path(
        'bot/templates/<slug:slug>/apply/',
        views_panel_catalog.StoreTemplateApplyView.as_view(),
        name='bot_template_apply',
    ),
    ...
    path(
        'catalog/templates/export/',
        views_panel_catalog.StoreTemplateExportAllView.as_view(),
        name='catalog_templates_export',
    ),
    path(
        'catalog/templates/import/',
        views_panel_catalog.StoreTemplateImportView.as_view(),
        name='catalog_templates_import',
    ),
    path(
        'catalog/templates/delete-all/',
        views_panel_catalog.StoreTemplateDeleteAllView.as_view(),
        name='catalog_templates_delete_all',
    ),
    path(
        'catalog/templates/<slug:slug>/export/',
        views_panel_catalog.StoreTemplateExportView.as_view(),
        name='catalog_template_export',
    ),
    path(
        'catalog/templates/<slug:slug>/delete/',
